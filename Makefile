...
#    Updated: 2023/10/05 09:47:50 by yuboktae         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_FILES	=	main/minishell.c main/signals.c init/init_all.c \
				...
				lexer/create_tokens.c lexer/expand_token.c lexer/expand_utils.c \
				...
				execution/multi_cmd_utils_2.c execution/create_fd_redir.c \
				execution/create_heredoc.c execution/redir_utils.c \
